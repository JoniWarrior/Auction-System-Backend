...
export class AddDeletedAtColumn1761052179008 implements MigrationInterface {
    name = 'AddDeletedAtColumn1761052179008'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "biddings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "auctionId" uuid, "bidderId" uuid, CONSTRAINT "PK_7e33475be248d1fa69b1ccaa74a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "auctions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "startingPrice" integer NOT NULL, "currentPrice" integer NOT NULL, "endTime" TIMESTAMP NOT NULL, "status" "public"."auctions_status_enum" NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "itemId" uuid, "winnerBidId" uuid, CONSTRAINT "REL_d6147892790737abeeac9f902a" UNIQUE ("itemId"), CONSTRAINT "REL_35e61d3edbf0f7cb012501e334" UNIQUE ("winnerBidId"), CONSTRAINT "PK_87d2b34d4829f0519a5c5570368" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_eec682e1e2b3c3d8ebaec7f2b5" ON "auctions" ("status", "endTime") `);
        await queryRunner.query(`CREATE TABLE "items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "imageURL" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "sellerId" uuid, CONSTRAINT "PK_ba5885359424c15ca6b9e79bcf6" PRIMARY KEY ("id"))`);
