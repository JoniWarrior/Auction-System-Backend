...
export class InitialCamelcaseSchema1760967104238 implements MigrationInterface {
    name = 'InitialCamelcaseSchema1760967104238'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auctions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "startingPrice" integer NOT NULL, "currentPrice" integer NOT NULL, "endTime" TIMESTAMP NOT NULL, "status" "public"."auctions_status_enum" NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "itemId" uuid, "winnerBidId" uuid, CONSTRAINT "REL_d6147892790737abeeac9f902a" UNIQUE ("itemId"), CONSTRAINT "REL_35e61d3edbf0f7cb012501e334" UNIQUE ("winnerBidId"), CONSTRAINT "PK_87d2b34d4829f0519a5c5570368" PRIMARY KEY ("id"))`);
